...
The final version (both raw and cleaned data) of the dataset used when actually testing the models are placed inside of the "final-dataset/" folder, with "batch_round.csv" being the raw data and "batch_rounds_flat_turns.csv" being the cleaned data.